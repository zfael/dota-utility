...
fn trigger_sequence(enigo: &mut Enigo) {
    ...
    enigo.key(Key::Unicode('x'), Click); // Press 'c'
    ...
    thread::sleep(time::Duration::from_millis(30)); // Wait 50ms
    thread::sleep(time::Duration::from_millis(30)); // Wait 50ms
    enigo.key(Key::Unicode('c'), Click); // Press 'c'
    enigo.key(Key::Unicode('c'), Click); // Press 'c'
    enigo.key(Key::Unicode('c'), Click); // Press 'c'
    enigo.key(Key::Unicode('c'), Click); // Press 'c'
    enigo.key(Key::Unicode('c'), Click); // Press 'c'
    ...
    enigo.key(Key::Unicode('q'), Click); // Press 'c'
    enigo.key(Key::Unicode('q'), Click); // Press 'c'
    thread::sleep(time::Duration::from_millis(7300)); // Wait 50ms


    // enigo.key(Key::Unicode('0'), Click); // Press 'c'
    // thread::sleep(time::Duration::from_millis(10)); // Wait 50ms
    // enigo.key(Key::Unicode('0'), Click); // Press 'c'
    // thread::sleep(time::Duration::from_millis(10)); // Wait 50ms
    // enigo.key(Key::Unicode('0'), Click); // Press 'c'
    // thread::sleep(time::Duration::from_millis(10)); // Wait 50ms
